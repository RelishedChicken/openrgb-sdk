...
/**
 * Commands list with their IDs as detailed on OpenRGB's [SDK Docs](https://gitlab.com/CalcProgrammer1/OpenRGB/-/blob/master/Documentation/OpenRGBSDK.md#packet-ids) 
 */
...
/**
 * Device type list with their IDs
 */
